...
async function resolve(pathname) {
  ...
  const STATIC = {
    "/": {
      ...
      h1: "うちの子を愛してる人が集まる街。",
      lead:
        "Qocca(クオッカ)は、ペットオーナーとクリエイターをつなぐ日本発のペット専門マーケットプレイスです。似顔絵・ハンドメイド服・フォト撮影・オリジナルグッズなどを扱い、売上の3%を特定非営利活動法人アニマルレフュージ関西(認定NPO法人)に寄付しています。ペット同伴可の施設マップや、うちの子と歩ける散歩スポットも収録しています。",
      links: [
