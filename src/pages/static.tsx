...
export const FAQPage = ({ setPage, isPC }: { setPage: (p: string) => void; isPC?: boolean }) => {
  const faqs = [
    { q: "Qocca(クオッカ)とは何ですか?", a: "Qocca は、ペットオーナーとクリエイターをつなぐ日本発のペット専門マーケットプレイスです。売上の 3% を特定非営利活動法人アニマルレフュージ関西(認定NPO法人)に寄付しています。" },
    ...
    { q: "寄付の仕組みを教えてください", a: "Qocca の売上 3% を月次で集計し、特定非営利活動法人アニマルレフュージ関西(認定NPO法人) (略称 ARK) へ送金しています。寄付内訳は公開ダッシュボードで開示しています。" },
