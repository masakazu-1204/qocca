...
const FeesGuide: React.FC = () => {
  ...
  return (
    <PageWrap>
      ...
      <H3>キャンペーン期間</H3>
      <ul style={{ fontSize: 13, lineHeight: 1.9, color: "#555", paddingLeft: 22, marginBottom: 12 }}>
        <li>開始: <strong>2026年6月3日</strong>(クラウドファンディング開始日)</li>
      ...
      <H3>適用イメージ (2026年6月3日にご購入の場合)</H3>
      <ul style={{ fontSize: 13, lineHeight: 1.9, color: "#555", paddingLeft: 22, marginBottom: 12 }}>
        <li>2026年6月3日 〜 7月31日: <strong>0%</strong> (ウェルカムキャンペーンが優先)</li>
...
const CAMPFIRE_FAQS: FaqItem[] = [
  ...
  { section: "🎁 リターンについて", q: "動物福祉団体募金リターンって何ですか?",
    a: "¥3,000のリターンには、¥2,000が特定非営利活動法人アニマルレフュージ関西へ寄付される仕組みが含まれています。特定非営利活動法人アニマルレフュージ関西は1990年から活動されている日本最大級の動物保護施設です。Qoccaは売上の3%も特定非営利活動法人アニマルレフュージ関西へ寄付しており、本リターンは「Qoccaの応援 + 動物保護への直接貢献」を同時にできる特別なリターンです。\n\n※特定非営利活動法人アニマルレフュージ関西との連携を運用ルールに沿って進めています。" },
