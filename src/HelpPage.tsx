...
const StripeConnectGuide: React.FC = () => (
  <PageWrap>
    ...
    <H3>振込について</H3>
    <ul style={{ fontSize: 13, lineHeight: 1.9, color: "#555", paddingLeft: 22 }}>
      <li>💴 <strong>最低振込申請額: 3,000 円</strong>（売上残高が 3,000 円以上で振込申請可能）</li>
      <li>🏦 振込手数料: <strong>1 回あたり 275 円（税込）</strong></li>
      <li>📅 振込申請後、数営業日以内に登録口座へ入金されます</li>
    </ul>

    <H3>手数料の詳細</H3>
    <P>取引完了時に以下の手数料が引かれた金額が売上として計上されます。</P>
    <ul style={{ fontSize: 13, lineHeight: 1.9, color: "#555", paddingLeft: 22 }}>
    ...
    <Note color="green">
      ...
      3ヶ月以内: 1,000 円 - Stripe 36 円 - Qocca 50 円 = <strong>914 円</strong> が売上<br/>
      <span style={{ fontSize: 11, color: C.warmGray }}>※ 振込時には別途 振込手数料 275 円（税込）がかかります。</span>
    </Note>
...
const BuyingGuide: React.FC = () => (
  <PageWrap>
    ...
    <FAQ q="キャンセルしたい" a={<>
      ...
      購入者都合の納品前キャンセル: 決済手数料（商品代金の3.6%）を差し引いた金額が返金されます。<br/>
      納品済み・受取確認後: 原則キャンセル不可です。
    </>} />
    <FAQ q="返金はされますか？" a={<>
      出品者都合による返金は<strong>全額返金</strong>（決済手数料は出品者負担）。<br/>
