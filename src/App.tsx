...
{homeEvents.map(ev => (
                <div key={ev.id} onClick={()=>setPage("events")} style={{
                  ...
                  <div style={{ width:50, height:50, borderRadius:12, background: ev.pet_type === "dog" ? "#FFF3E0" : ev.pet_type === "cat" ? "#F3E5F5" : "#E8F5E9", display:"flex", alignItems:"center", justifyContent:"center", fontSize:24, flexShrink:0, overflow:"hidden" }}>{ev.image_url && ev.image_url.startsWith("http") ? <img src={ev.image_url} alt="" style={{ width:"100%", height:"100%", objectFit:"cover" }}/> : (ev.image_url || "🐾")}</div>
                  <div style={{ flex:1, minWidth:0 }}>
                      ...
                      {homeEvents.map(ev => (
                        <div key={ev.id} onClick={()=>setPage("events")} style={{
                          ...
                          <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:10 }}>
                            <div style={{ width:44, height:44, borderRadius:10, background: ev.pet_type === "dog" ? "#FFF3E0" : ev.pet_type === "cat" ? "#F3E5F5" : "#E8F5E9", display:"flex", alignItems:"center", justifyContent:"center", fontSize:22, overflow:"hidden" }}>{ev.image_url && ev.image_url.startsWith("http") ? <img src={ev.image_url} alt="" style={{ width:"100%", height:"100%", objectFit:"cover" }}/> : (ev.image_url || "🐾")}</div>
                            <div style={{ flex:1, minWidth:0 }}>
