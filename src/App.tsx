...
// ── Threads 連携ページ (Phase Threads, 2026/5/23) ─────────────────────────
...
const ThreadsConnectionPage = ({ setPage: _setPage }: { setPage: (p: string) => void }) => {
  ...
  // OAuth 開始 (Meta authorize ページに遷移)
  const startOAuth = () => {
    if (!user?.id) return;
      ...
      {isPC ? (
        <div style={{ paddingTop:68 }}>
          <Routes>
            ...
            {/* Phase Threads (5/23): /settings/threads */}
