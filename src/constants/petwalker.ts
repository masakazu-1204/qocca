...
export const PW_AREAS: PWArea[] = [
  ...
  { tag: "仙台",          en: "Sendai",       blurb: "杜の都と、渓谷の湯。",         slug: "sendai",      img: pwImg("sendai"),      kind: "area" },
  ...
  { tag: "鎌倉",          en: "Kamakura",     blurb: "古都の風と、海の音。",         slug: "kamakura",    img: pwImg("kamakura"),    kind: "area" },
  ...
  { tag: "神戸",          en: "Kobe",         blurb: "港の風と、坂の街。",           slug: "kobe",        img: pwImg("kobe"),        kind: "area" },
  ...
  { tag: "宮島",          en: "Miyajima",     blurb: "海に立つ、朱の鳥居。",         slug: "miyajima",    img: pwImg("miyajima"),    kind: "area" },
