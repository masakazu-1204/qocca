...
### 2026/8/22〜9/20 「AdSetA_探索_全国」(トラフィック目的・¥2,000/日) → 停止して作り直し (King 判断 2026/9/21)

```
消化 ¥60,060 / LP表示 7,438 (¥8.08) / リーチ 54,561
登録: 広告期間 34名 vs 直前30日 28名 (週 8〜9 で変化なし) / 注文 0 / Meta 経由の痕跡がある登録 0件
```

学び:
- **トラフィック目的は「LP を開く人」を安く集めるだけで、登録には効かなかった** (この Skill の「Traffic は使わない」のとおり)
- **広告リンクに utm が付いていなかった**。Instagram アプリ内ブラウザは referrer を送らないので、utm 無し = 計測不能。
